    ...
    <>
      <div className="max-w-5xl mx-auto px-6 py-16 space-y-24">
        <section className="animate-fade-in-up">
          ...
          <h1 className="font-sans font-bold text-7xl mb-4 leading-none text-slate-200">
            Moira
          </h1>
        ...
        <section>
          <div className="flex items-end justify-between mb-6">
            <div>
              ...
              <h2 className="font-sans font-bold text-3xl text-slate-200">
                Half Baked Thoughts
              </h2>
            </div>
            <Link href="/blogs" className="font-mono text-xs flex items-center gap-1 text-slate-500 hover:text-slate-300 transition-colors duration-200">
